module.exports = {
  ...
  schema: [
    ...
    },
    {
      ...
      input: 'multiselect',
      source: ['complete', 'email', 'directMail', 'SMS', 'mobile', 'phone', 'survey'],
    },
    {
    ...
    },
    {
      ...
      input: 'select',
      source: ['none', 'vdm', 'driveaway_polk'],
    },
    {
      label: 'Postal Code',
    ...
    },
    {
      ...
      input: 'select',
      source: ['toggle', 'enforced_to_read'],
    },
    {
      label: 'Body',
    ...
    },
    {
      ...
      input: 'select',
      source: ['gregorian', 'iso8601', 'buddhist', 'chinese'],
      required: true,
    },
    {
      label: 'Key',
