...
class JsonStore {
  ...
  /*
   * Whether a record id belongs to this server. h.isOwnRecord is the one definition of that; the
   * admin's `_local` flag asks it too, so a record this store accepts is a record the admin offers
   * to edit (#105).
   *
   ...
   */
  owns (id) {
    return h.isOwnRecord(id, this._id)
  }
