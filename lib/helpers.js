...
const filterQuery = function (query, page, limit) {
...
exports.openReadStream = function (context) {
  context.stream = context.resource.json.read(context.params.query)
  context.next()
}
...
exports.profile = function (context) {
  ...
  context.on('end', () => {
    ...
    console.log(`${context.endpoint.name} took ${duration}ms.`)
  })
  context.next()
}
...
exports.filterQuery = function (context) {
  context.stream = context.stream.pipe(filterQuery(context.params.query, context.params.options.page, context.params.options.limit))
  context.next()
}
