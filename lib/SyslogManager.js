...
class SyslogManager extends PluginManager {
  ...
  generateExampleLog() {
    const exampleLogs = [
      "9999/99/99 99:99:99.9999 Emojis Example: 🐛 to ✂️ Copy and 📋 Paste 👌",
      "9999/99/99 99:99:99.9999 Standard ANSI Example: \u001b[36mBlue Example\u001b[39m!",
      "9999/99/99 99:99:99.9999 None-Standard ANSI Example: #033[37mGray Example #033[39m!",
      `9999/99/99 99:99:99.9999 Chalk Example: ${chalk.blue.bgRed.bold('White Text with Red Background Example')}!`,
      "9999/99/99 99:99:99.9999 Normal Example: Hello World!",
      "9999/99/99 99:99:99.9999 A multiline Example: \nHello World!\nFrom a multiline example!",
      "9999/99/99 99:99:99.9999 An inspect Example: \n" + util.inspect({ example: 'string', nested: { a: { b: 1, c: 2, d: 'string' } } }, { showHidden: false, depth: null, colors: true }),
      "9999/99/99 99:99:99.9999 A table Example: \n" + table([
        ['0A', '0B', '0C'],
        ['1A', '1B', '1C'],
        ['2A', '2B', '2C']
      ]),
    ]
    this.injectDataToSyslogData(exampleLogs[_.random(0, exampleLogs.length - 1)])
