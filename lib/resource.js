...
class Resource {
  ...
  setupAttachmentHooks(driver) {
    ...
    // TODO: cache the resized image and if there's already a cache of that image with the same field.options.widthxfield.options.height, return that cache instead
