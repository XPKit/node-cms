  ...
  return function () {
    ...
    if (!opts.disableJwtLogin) {
      ...
      admin.get('/', (req, res, next) => {
        ...
        if (cms.getUserFromToken && _.isEmpty(cms.getUserFromToken(req))) {
    ...
    admin.get('/login', async (req, res, next) => {
      ...
      if (!_.get(options, 'disableJwtLogin', false)) {
        console.warn(`dwhjkawdawdjkawd`)
        if (!_.get(req, 'session.nodeCmsUser', false) && cms.getUserFromToken && _.isEmpty(cms.getUserFromToken(req))) {
