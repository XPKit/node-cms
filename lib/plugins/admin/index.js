...
class Admin {
  ...
  initialize() {
    ...
    this.configFieldsToExpose = ['autoload', 'disableJwtLogin', 'disableAuthentication', 'blockRetry', 'import', 'importFromRemote', 'syslog', 'sync', 'toolbarTitle', 'webserver', 'wsRecordUpdates']
