...
const Admin = function (options) {
  ...
  return function () {
    ...
    const config = _.pick(options, ['autoload', 'disableJwtLogin', 'disableAuthentication', 'apiVersion', 'blockRetry', 'import', 'syslog', 'sync', 'toolbarTitle', 'webserver', 'wsRecordUpdates'])
