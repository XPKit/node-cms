...
class XlsxManager {
   ...
   * with commas, attachments as their URL, date-like numbers as Date objects and wysiwyg content
  ...
  getExportCellValue (item, keyItem) {
    ...
    if (inputType === 'wysiwyg' && !_.isUndefined(value) && !_.isBoolean(value) && !_.isNumber(value)) {
      // skip by kong, error with some special element
      return 'wysiwyg is not suppported'
    }
