...
const prime = Buffer.from(
  '90b9aba88393569cf93687b9e8473e0ae9d970724ce18ca89a4afd54e7fb1b3bdeb735d4f22fadd8e374581d98d78a923a36f127e50ea957fa275acc1a8db4a3',
  'hex',
)
...
const DH = (socket, callback) => {
  read(socket, (clientPublicKey) => {
    ...
    read(socket, (clientSharedKey) => {
      if (clientSharedKey.toString('hex') !== sharedKey.toString('hex')) {
