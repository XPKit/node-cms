...
class SyncClass {
  ...
  checkEnvironmentToken = async (req, res, next) => {
    try {
      const syncConfig = await this.api('_sync').find({})
  ...
  onPostSyncResourceFromTo = async (req, res, next) => {
    try {
      const syncConfig = await this.api('_sync').find({})
  ...
  onGetSyncEnvironmentResourceStatus = async (req, res, next) => {
    try {
  ...
  onGetSyncEnvironmentResource = async (req, res, next) => {
    try {
  ...
  onGetSyncResourceAttachment = async (req, res, next) => {
    try {
  ...
  onGetSyncResource = async (req, res, next) => {
    try {
      if (!_.includes(req.syncInfo.allows, 'read')) {
        throw new Error('read data is not allowed')
      }
  ...
  onGetSyncResourceStatus = async (req, res, next) => {
    try {
      ...
      try {
        ...
        // Non-fatal: the status still stands without the permissions attached to it.
        logger.warn('Could not read the _sync config while reporting status:', error.message)
      }
      res.send(result)
    } catch (error) {
      next(error)
  ...
  checkResource = async (req, res, next) => {
    try {
      const resource = req.params.resource
  ...
  onPutSyncResource = async (req, res, next) => {
    try {
