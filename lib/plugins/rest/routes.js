 ...
 * Find file
 */
const findFile = async function (req, res) {
  if (!req.resource) {
    return res.status(500).send('resource not found')
  }
  try {
 ...
 */
const findAttachment = async function (req, res) {
  if (!req.resource) {
    return res.status(500).send('resource not found')
  }
  try {
 ...
 */
const findCroppedAttachment = async function (req, res) {
  if (!req.resource) {
    return res.status(500).send('resource not found')
  }
  try {
 ...
 */
const createAttachment = async function (req, res) {
  if (!req.resource) {
    return res.status(500).send('resource not found')
  }
 ...
 */
const updateAttachment = async function (req, res) {
  if (!req.resource) {
    return res.status(500).send('resource not found')
  }
  if (!req.is('json')) {
 ...
 */
const removeAttachment = async function (req, res) {
  if (!req.resource) {
    return res.status(500).send('resource not found')
  }
  try {
