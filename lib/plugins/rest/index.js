...
class Rest {
  ...
  initialize() {
    ...
    app.get(
      '/:resource([\\w-_]+)/:id([\\w-_]+)/attachments/:aid([\\w-_]+).:ext([\\w-_]+)?',
      mw.find_resource(this),
      mw.authorize(this),
      mw.parse_query,
      routes.findAttachment,
    )
    app.get(
