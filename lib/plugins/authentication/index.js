  ...
  return function () {
    ...
    const verifyToken = this.verifyToken = (req, res, next = false) => {
      ...
      try {
        ...
        // console.warn(`VERIFY TOKEN = `, _.get(req, 'session.nodeCmsUser', false))
    ...
    this.onGetLogout = async function (req, res, next) {
      try {
        ...
        // TODO: hugo - delete jwt token in hidden resource
    ...
    this.onPostLogin = async (req, res) => {
      ...
      // TODO: hugo - add token in hidden resource
