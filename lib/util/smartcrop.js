  ...
  async loadModels() {
    try {
      ...
      try {
        ...
        logger.error('TensorFlow.js not found. To use smart cropping, please run:')
        logger.error('  npm install @tensorflow/tfjs-node @tensorflow-models/blazeface @tensorflow-models/coco-ssd')
