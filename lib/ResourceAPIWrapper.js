...
class ResourceAPIWrapper {
  /**
   * Register a before hook for a resource method
   * @param {string} method - The method name (e.g., 'update')
   * @param {Function} fn - The hook function
   */
  before(method, fn) {
    return this._resource.before(method, fn)
  }

  /**
   * Register an after hook for a resource method
   * @param {string} method - The method name (e.g., 'update')
   * @param {Function} fn - The hook function
   */
  after(method, fn) {
    return this._resource.after(method, fn)
  }
  /**
   ...
   * @returns {Object} The resource options
   */
  get options() {
    return this._resource.options
  }
  /**
