 ...
 *
 */
// TODO: hugo - might need to refactor to merge with syncMongoDb.js since most of the logic will be the same
class SyncXPKIT {
  ...
  async pipeLocalDataToSocket (socket, isSendDataOut, slave) {
    await delay(500) // delay, wait the receive socket is ready
