...
describe('HTTP', async () => {
  ...
  //     await cms.groups.update(group._id, {read: group.read})
  //   })
  ...
  //       .expect(200)
  //     article = body
  //     const result = await request(helper.MASTER_URL)
  ...
  //     return await helper.getRequest(`/api/articles/${article._id}`, 200, false, true)
  //   })

  //   it('should allow anonymous read access to attachments', async () => {
  //     return await helper.getRequest(`/api/articles/${article._id}/attachments/${attachment._id}`, 200, 'image/png', true)
  //   })

  //   it(`shouldn't allow anonymous write access`, async () => {
  //     return await request(helper.MASTER_URL)
  //       .post('/api/articles')
